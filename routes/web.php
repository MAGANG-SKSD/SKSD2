...
// Route untuk mengambil kelompok no rekening berdasarkan jenis
Route::get('/kelompok_norekening/{Id}', [AnggaranController::class, 'getKelompokNorekening']);

// Route untuk mengambil detail no rekening berdasarkan kelompok
Route::get('/detail_norekening/{Id}', [AnggaranController::class, 'getDetailNorekening']);
