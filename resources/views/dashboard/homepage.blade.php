            ...
            <div class="col-xl-3 col-md-6 col-sm-12">
                ...
                <div class="card comp-card text-center">
                    <div class="card-body">
                        ...
                        <h3>{{ $user }}</h3>
                        <a href="users" class="btn btn-primary btn-sm">{{ __('View Users') }}</a>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 col-sm-12">
                ...
                <div class="card comp-card text-center">
                    <div class="card-body">
                        ...
                        <h3>{{ $role }}</h3>
                        <a href="roles" class="btn btn-info btn-sm">{{ __('View Roles') }}</a>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 col-sm-12">
                ...
                <div class="card comp-card text-center">
                    <div class="card-body">
                        ...
                        <h3>{{ $modual }}</h3>
                        <a href="modules" class="btn btn-success btn-sm">{{ __('View Modules') }}</a>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 col-sm-12">
                ...
                <div class="card comp-card text-center">
                    <div class="card-body">
                        ...
                        <h3>{{ $languages }}</h3>
                        <a href="language" class="btn btn-danger btn-sm">{{ __('View Languages') }}</a>
                    </div>
