...
$desaDetail = Desa::find(request()->route('id')); // Assuming your route parameter is 'id'
@endphp
            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    <div desa_id="desas-add-1" class="card bg-primary text-white">
                        <div class="card-body">
                            <h4 class="mb-1 text-white">{{ $desaDetail->nama_desa }}</h4> <!-- Changed to use $desaDetail -->
                        </div>
                    </div>
                    <div desa_id="desas-add-2" class="card">
                        ...
                        {{ Form::model($desaDetail, ['route' => ['desas.update', $desaDetail->desa_id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }} <!-- Update the route with the specific id -->
                        <div class="card-body">
